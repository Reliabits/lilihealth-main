...
import VisualFeedbackContext, { IVisualFeedbackContext } from './VisualFeedbackContext';
...
const VisualFeedbackComponent = ({ children }: VisualFeedbackComponentProps) => {
  ...
  function showDialog(params: { title?: string; message: string; onOKClick?: () => void }): void {
    Alert.alert(
      params.title ?? 'Atención',
      params.message,
      [
        {
          text: 'OK',
