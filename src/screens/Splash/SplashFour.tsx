  ...
  return (
    <View style={{ flex: 1, backgroundColor: '#ffffff' }}>
      ...
      <View style={styles.image}>
        <Image style={{ width: '100%', height: imageHeight }} source={splash4} />
      </View>
      ...
      <View style={styles.textView}>
        <Text style={styles.text}>
          Find your balance and track your progress to stay motivated and accountable{' '}
        </Text>
      </View>
      <View style={{ flex: 1, justifyContent: 'flex-end' }}>
        ...
        <View style={styles.buttonView}>
          <TouchableOpacity
            onPress={() => NavService.navigate(EStacks.AUTH_STACK)}
            style={styles.button}
          >
