  ...
  return (
    <View style={{ flex: 1, backgroundColor: '#ffffff' }}>
      ...
      <View style={styles.image}>
        <Image style={{ width: '100%', height: imageHeight }} source={splash2} />
      </View>
      ...
      <View style={styles.textView}>
        <Text style={styles.text}>
          Discover simple, tasty recipes that nourish your mind and body with just a few ingredients{' '}
        </Text>
      </View>
      ...
      <View style={{ flex: 1, justifyContent: 'flex-end' }}>
        ...
        <View style={styles.buttonView}>
          <TouchableOpacity
            onPress={() => {
              NavService.navigate(ESPLASH.SPLASHTHREE);
            }}
            style={styles.button}
          >
